import { extend, inherits, array, accessorName, error, accessorFields, accessor, merge, compare, truthy, extent, span, toNumber, fastmap, hasOwnProperty, isArray, field, key, ascending, peek, constant, extentIndex, identity, zero } from 'vega-util';
import { Transform, replace, ingest, tupleid, stableCompare, Operator, derive, rederive } from 'vega-dataflow';
import { bin, sampleCurve, dotbin, randomKDE, quantiles, quartiles, bootstrapCI, random, randomMixture, randomNormal, randomLogNormal, randomUniform } from 'vega-statistics';
import { range, bisector, median, mean, min, max } from 'd3-array';
