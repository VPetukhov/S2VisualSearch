import { truthy, error, hasOwnProperty, isFunction, isString, extend, isArray, field, peek, isBoolean, isDate, isNumber, isObject, isRegExp, toBoolean, toDate, toNumber, toString, flush, lerp, pad, span, inrange, truncate, quarter, utcquarter, extent, clampRange, panLinear, panLog, panPow, panSymlog, zoomLinear, zoomLog, zoomPow, zoomSymlog, stringValue, identity, array as array$1 } from 'vega-util';
import { Literal, constants, codegenExpression, functions, parseExpression, CallExpression } from 'vega-expression';
