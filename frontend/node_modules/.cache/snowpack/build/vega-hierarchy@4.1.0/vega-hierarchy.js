import { Transform, isTuple, ingest, stableCompare, tupleid } from 'vega-dataflow';
import { inherits, error, array, one, hasOwnProperty, truthy } from 'vega-util';
import { hierarchy, pack, partition, stratify, treemap, tree, cluster, treemapBinary, treemapDice, treemapSlice, treemapSliceDice, treemapSquarify, treemapResquarify } from 'd3-hierarchy';
